...
//| panel: input
//| layout-ncol: 1
viewof country = Inputs.radio(
  new Map([["Any country", null], ["United States", "US"]]), 
  {value: null, label: "Region"}
)
viewof group = Inputs.radio(
  new Map([["Any group", null], ["Teens", "teens"], ["Restaurants or retail", "rest_retail"], ["Overall workforce", "overall"]]), 
  {value: null, label: "Group"}
)
viewof published = Inputs.radio(
  [null, "Published"], 
...
data <- targets::tar_read(owe_data) %>% 
