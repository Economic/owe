...
The own-wage elasticity (OWE) of employment is an estimate of the employment change for a given wage change experienced by a group of workers, where in this case the changes in wages and employment are due to minimum wage increases. The median OWE of the \${count_studies} studies above is \${median_formatted}.
